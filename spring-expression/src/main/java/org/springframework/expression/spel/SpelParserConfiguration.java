...
public class SpelParserConfiguration {
	...
	/**
	 * System property to configure the default compiler mode for SpEL expression
	 * parsers: {@value}.
	 */
	...
	static {
		...
		defaultCompilerMode = (compilerMode != null ? SpelCompilerMode.valueOf(compilerMode.toUpperCase(Locale.ROOT))
	 ...
	 * @param autoGrowNullReferences  if null references should automatically grow
	 * @param autoGrowCollections     if collections should automatically grow
	 * @param maximumAutoGrowSize     the maximum size that a collection can auto
	 *                                grow
