...
abstract class CronField {
	...
	/**
	 * Parse the given value into a seconds {@code CronField}, the first entry of a
	 * cron expression.
	 */
	...
	/**
	 * Parse the given value into a minutes {@code CronField}, the second entry of a
	 * cron expression.
	 */
	...
	/**
	 * Parse the given value into an hours {@code CronField}, the third entry of a
	 * cron expression.
	 */
	...
	/**
	 * Parse the given value into a days of months {@code CronField}, the fourth
	 * entry of a cron expression.
	 */
	...
	/**
	 * Parse the given value into a month {@code CronField}, the fifth entry of a
	 * cron expression.
	 */
	...
	/**
	 * Parse the given value into a days of week {@code CronField}, the sixth entry
	...
	private static CronField parseList(String value, Type type,
			BiFunction<String, Type, CronField> parseFieldFunction) {
	...
	protected enum Type {
		...
		HOUR(ChronoField.HOUR_OF_DAY, ChronoUnit.DAYS, ChronoField.MINUTE_OF_HOUR, ChronoField.SECOND_OF_MINUTE,
				ChronoField.NANO_OF_SECOND),
		DAY_OF_MONTH(ChronoField.DAY_OF_MONTH, ChronoUnit.MONTHS, ChronoField.HOUR_OF_DAY, ChronoField.MINUTE_OF_HOUR,
				ChronoField.SECOND_OF_MINUTE, ChronoField.NANO_OF_SECOND),
		MONTH(ChronoField.MONTH_OF_YEAR, ChronoUnit.YEARS, ChronoField.DAY_OF_MONTH, ChronoField.HOUR_OF_DAY,
				ChronoField.MINUTE_OF_HOUR, ChronoField.SECOND_OF_MINUTE, ChronoField.NANO_OF_SECOND),
		DAY_OF_WEEK(ChronoField.DAY_OF_WEEK, ChronoUnit.WEEKS, ChronoField.HOUR_OF_DAY, ChronoField.MINUTE_OF_HOUR,
				ChronoField.SECOND_OF_MINUTE, ChronoField.NANO_OF_SECOND);
