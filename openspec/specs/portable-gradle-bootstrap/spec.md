# portable-gradle-bootstrap Specification

## Purpose
Define a portable and integrity-checked Gradle Wrapper bootstrap contract that works across developer machines and CI, supports exact-version local cache prewarming, and exposes a consistent Make test entry point.
## Requirements
