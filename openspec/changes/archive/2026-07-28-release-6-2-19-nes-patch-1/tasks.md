...
- [x] 4.3 Create the dedicated release commit for `spring-framework-6.2` `6.2.19-nes.patch.1`.
...
- [x] 7.1 Confirm `v6.2.19-nes.patch.1` does not already exist locally or remotely and the target release commit SHA is unchanged.
- [x] 7.2 Create annotated tag `v6.2.19-nes.patch.1` on the exact release commit only after `nexus-verified`.
